...
'{"sku":"mddk4", "name":"World War I", "price":20, "type": "BOOK",
"specs":"45"}' http://localhost/store-test-assignment-backend/apis/create.php


INSERT INTO `products`(`sku`, `name`, `price`, `type`, `specs`) VALUES
("JVC166123","Word war I",55,"BOOK","20");
